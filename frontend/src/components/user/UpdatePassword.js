...
export default function UpdatePassword(){
    ...
    const submitHandler = (e) => {
        ...
        dispatch(updatePasswordAction(formData));  //Will send formData as a parameter to updatePassword action folder...
    }
    ...
    useEffect(() => {
        if(isUpdated) {
            ...
            setOldPassword("");   //After changed Password input field should be empty...
            setPassword("");
            return;
        }
