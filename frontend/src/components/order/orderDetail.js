...
export default function OrderDetail(){
    ...
    // Provide default values if OrderDetail is not available yet
    const { shippingInfo={}, 
    ...
    const {id} = useParams();  //To access id parameter...

    useEffect(() => {
        dispatch(orderDetailAction(id))   //Pass id inside as argument...
    },[id]);
